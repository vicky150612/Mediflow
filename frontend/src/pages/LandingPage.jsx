...
const features = [
    ...
    },
    {
        icon: "🗂️",
        title: "Storage",
        desc: "All medical documents, reports, and prescriptions are stored in a accessible location. Access your files anytime, anywhere with complete peace of mind.",
            ...
            <header ref={heroRef} className="flex flex-col-reverse lg:flex-row items-center max-w-6xl mx-auto px-4 py-20 gap-12">
                <div className="flex-1 space-y-6">
                    ...
                    <div className="flex space-x-4 opacity-100">
                        <button ref={buttonRef} className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-7 rounded-lg shadow-lg transform transition hover:scale-105 opacity-100 cursor-pointer" onClick={() => navigate('/signup')}>
                            Get Started Free
                        </button>
                    </div>
                </div>
                <div ref={doctor3DRef} className="flex-1 flex justify-center">
                    <Doctor3D />
                </div>
            </header>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                        {features.slice(0, 3).map((f, i) => (
                            <div
                                ...
                                className="bg-white/5 backdrop-blur-md rounded-xl p-6 flex flex-col items-start hover:shadow-lg hover:shadow-blue-500/20 transition-transform transform duration-300"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Report a bug</a></li>
                            </ul>
                        </div>
                    </div>

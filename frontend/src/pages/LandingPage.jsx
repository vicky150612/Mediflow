...
const features = [
    ...
    },
    {
        ...
        desc: "Complete digital prescription management allowing doctors to create prescriptions and patients to track their medication history with active/inactive status monitoring.",
        highlight: "Digital prescriptions"
    },
];
    ...
    return (
        <div className="min-h-screen bg-[#0a0b0f] text-gray-100">
            ...
            <section ref={featuresRef} className="py-16 bg-[#16171e]">
                <h2 ref={featRef} className="text-3xl font-bold text-center mb-12">Core Features</h2>
                ...
                <div className="max-w-6xl mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="space-y-4">
                            ...
                            <div className="flex space-x-4">
                                <a href="www.linkedin.com/in/shashank-peddi" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                                    {/* LinkedIn SVG */}
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                                </a>
                                <a href="https://github.com/vicky150612" aria-label="GitHub" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                                    {/* GitHub SVG */}
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li key="contact"><a href="mailto:iamshashankpeddi@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-200">Contact Us</a></li>
                                <li key="bug"><a href="https://forms.gle/zcQqYUcnsUNsKT8n6" target="_blank" className="text-gray-400 hover:text-white transition-colors duration-200">Report a bug</a></li>
                            </ul>
                        </div>
                    </div>
